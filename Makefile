...
prefix          = /usr/local/pspdev/psp/sdk/..
exec_prefix     = ${prefix}
srcdir          = .
...
VERSION=2.2.1
VER_STRING=2.2.1
REL_STRING=Build from CVS snapshot on July 8, 2005
...
CC = psp-gcc
CXX = psp-g++
CFLAGS = -I/usr/local/pspdev/psp/sdk/include -I/usr/local/pspdev/psp/sdk/../include/SDL -Dmain=SDL_main -Wall -O2 -G0  `sdl-config --cflags` $(MCH_CFLAGS) $(FLA_FLAGS)  -DBX_SHARE_PATH='"$(sharedir)"'
CXXFLAGS = -I/usr/local/pspdev/psp/sdk/include -I/usr/local/pspdev/psp/sdk/../include/SDL -Dmain=SDL_main -Wall -O2 -G0 -fno-exceptions -fno-rtti  `sdl-config --cflags` $(MCH_CFLAGS) $(FLA_FLAGS)  -DBX_SHARE_PATH='"$(sharedir)"'
...
CFLAGS_CONSOLE = -I/usr/local/pspdev/psp/sdk/include -I/usr/local/pspdev/psp/sdk/../include/SDL -Dmain=SDL_main -Wall -O2 -G0 $(MCH_CFLAGS) $(FLA_FLAGS)
CXXFLAGS_CONSOLE = -I/usr/local/pspdev/psp/sdk/include -I/usr/local/pspdev/psp/sdk/../include/SDL -Dmain=SDL_main -Wall -O2 -G0 -fno-exceptions -fno-rtti $(MCH_CFLAGS) $(FLA_FLAGS)
BXIMAGE_LINK_OPTS = 
...
bxversion.h:
	$(RM) -f bxversion.h
	echo '/////////////////////////////////////////////////////////////////////////' > bxversion.h
	echo '// $$Id: Makefile.in,v 1.172.2.1 2005/07/06 20:28:23 vruppert Exp $$' >> bxversion.h
	echo '/////////////////////////////////////////////////////////////////////////' >> bxversion.h
...
install_win32: download_dlx 
	...
	#cat $(srcdir)/build/win32/DOC-win32.htm | $(SED) -e 's/2.2.1/$(VERSION)/g' > $(prefix)/DOC-win32.htm
